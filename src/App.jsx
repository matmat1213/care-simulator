...
const btnBase={width:28,height:28,borderRadius:6,border:`1px solid ${C.border}`,
    ...
    <div style={{minHeight:"100vh",background:C.bg,color:C.text,
        ...
        <div style={{maxWidth:740,margin:"0 auto"}}>
          <div style={{display:"flex",alignItems:"center",gap:8,marginBottom:2}}>
            <span style={{fontSize:10,fontWeight:700,color:C.green,
              border:`1px solid ${C.green}`,borderRadius:4,padding:"1px 6px"}}>DEMO</span>
      ...
      <div style={{maxWidth:740,margin:"0 auto",padding:"12px 12px 60px"}}>
          ...
          <div style={{display:"flex",alignItems:"center",gap:10,flexWrap:"wrap"}}>
            ...
            <div style={{display:"flex",alignItems:"center",gap:8}}>
              <input type="number" min={0} value={currentUnits} placeholder="0"
                ...
                style={{width:130,padding:"7px 10px",background:C.bg,
              ...
              {currentNum>0&&<button onClick={()=>setCurrentUnits("")} style={{
                ...
                background:"transparent",color:C.dim,fontSize:11,cursor:"pointer"}}>クリア</button>}
            </div>
          </div>
        </div>
        ...
        <div style={{background:C.surface,borderRadius:10,
          ...
          {(isOver||isWarn)&&<div style={{position:"absolute",top:0,left:0,right:0,height:3,
        ...
        <div style={{background:C.surface,borderRadius:10,
            ...
            {visTabs.map(t=>{
              ...
              return(
                <button key={t.key} onClick={()=>setActiveTab(t.key)} style={{
                  ...
                  {t.key}
                  {bt!==0&&!isActive&&(
                    <span style={{marginLeft:3,fontSize:10,background:C.blue,color:"#fff",
                      borderRadius:99,padding:"1px 5px"}}>{bt.toLocaleString()}</span>
                  )}
                </button>
              );
            })}
          ...
          {validTab==="通所介護"&&(
            <div>
              {deiList.map((dei,di)=>{
                ...
                return(
                  <div key={dei.id} style={{borderBottom:`1px solid ${C.border}`,
                    ...
                    <div style={{display:"flex",alignItems:"center",gap:8,
                      ...
                      <input type="text" value={dei.name}
                        ...
                        style={{flex:"1 1 100px",padding:"4px 8px",background:C.bg,
                      ...
                      return(
                        <div key={id} style={{display:"flex",alignItems:"center",gap:10,
                          ...
                          <div style={{flex:1,minWidth:0}}>
                            <div style={{fontSize:13,color:cnt>0?C.text:C.muted,
                              fontWeight:cnt>0?600:400}}>{tb.label}</div>
          ...
          {validTab==="短期入所生活介護"&&(
            <div>
              {TANKI_SEIKATSU.groups.filter(g=>isYoshien?g.forYoshien:g.forKaigo).map((g,gi,ga)=>{
                ...
                const cnt=tankiCounts[id]||0;
                return(
                  <div key={g.prefix} style={{display:"flex",alignItems:"center",gap:10,
                    padding:"10px 14px",
                ...
                return(
                  <div key={g.prefix}>
                    <div style={{padding:"8px 14px",background:C.surfaceAlt,
                      ...
                      borderBottom:`1px solid ${C.borderLight}`}}>{g.label}</div>
          ...
          {validTab==="福祉用具"&&(
            <div>
              ...
              {fukushi.map((row,idx)=>(
                <div key={idx} style={{display:"flex",alignItems:"center",gap:8,padding:"6px 14px",
                  ...
                  <input type="text" value={row.name} placeholder="例：特殊寝台"
                    ...
                    style={{flex:1,padding:"6px 8px",background:C.bg,
                  ...
                  <input type="number" value={row.unit} placeholder="単位数"
                    ...
                    style={{width:90,padding:"6px 8px",textAlign:"right",background:C.bg,
          ...
          {validTab==="その他"&&(
            <div>
                ...
                return(
                  <div key={idx} style={{display:"flex",alignItems:"center",gap:6,
                    ...
                    <input type="text" value={row.name} placeholder={`項目名 ${idx+1}`}
                      ...
                      style={{flex:1,padding:"5px 7px",background:C.bg,border:`1px solid ${C.border}`,
                    ...
                    <input type="number" value={row.unit} placeholder="単位"
                      ...
                      style={{width:80,padding:"5px 7px",textAlign:"right",background:C.bg,
                    ...
                    <input type="number" value={row.count} placeholder="回"
                      ...
                      style={{width:60,padding:"5px 7px",textAlign:"right",background:C.bg,
                        border:`1px solid ${C.border}`,borderRadius:5,color:C.text,fontSize:12,fontWeight:700}}/>
                    <span style={{width:76,textAlign:"right",fontSize:12,fontWeight:700,
              ...
              {otherTotal!==0&&<div style={{padding:"8px 14px",borderTop:`1px solid ${C.border}`,
        ...
        {/* リセット */}
        <button onClick={reset} style={{width:"100%",padding:"11px",
...
function SvcRow({svc,count,unitLabel,isLast,onChange}){
  return(
    <div style={{display:"flex",alignItems:"center",gap:10,padding:"10px 14px",
      ...
      <div style={{flex:1,minWidth:0}}>
        <div style={{fontSize:13,fontWeight:count>0?600:400,
          color:count>0?C.text:C.muted,lineHeight:1.4,marginBottom:2}}>{svc.name}</div>
        <div style={{fontSize:11,color:C.dim}}>
    ...
    <div style={{borderTop:`1px solid ${C.border}`}}>
      <button onClick={()=>setOpen(o=>!o)} style={{
        ...
        <span style={{display:"flex",alignItems:"center",gap:6}}>
          <span>{open?"▾":"▸"}</span>
          <span>加算・減算を入力</span>
          {total!==0&&<span style={{fontSize:11,fontWeight:700,
      ...
      {open&&<div>
          ...
          return(
            <div key={idx} style={{display:"flex",alignItems:"center",gap:6,
              ...
              <input type="number" value={row.unit} placeholder="単位"
                ...
                style={{width:72,padding:"5px 7px",textAlign:"right",background:C.bg,
                  border:`1px solid ${C.border}`,borderRadius:5,color:C.text,fontSize:12,fontWeight:700}}/>
              <input type="number" value={row.count} placeholder="回"
                onChange={e=>onUpdate(idx,"count",e.target.value)}
                style={{width:56,padding:"5px 7px",textAlign:"right",background:C.bg,
                  border:`1px solid ${C.border}`,borderRadius:5,color:C.text,fontSize:12,fontWeight:700}}/>
              <span style={{width:72,textAlign:"right",fontSize:12,fontWeight:700,
                color:sub===null?C.dim:sub>0?C.green:sub<0?C.red:C.dim}}>
                {sub!==null?`${sub>0?"+":""}${sub.toLocaleString()}`:"—"}
              </span>
            </div>
        ...
        {total!==0&&<div style={{padding:"8px 14px",borderTop:`1px solid ${C.border}`,
          display:"flex",justifyContent:"flex-end"}}>
